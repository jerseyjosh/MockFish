...
class ChessDataset(Dataset):
    def __init__(self, root, path, transforms=Compose([ToTensor(), Normalize()])):
        self.path = path
...
class Mockfish(nn.Module):
    def __init__(self, numChannels, classes):
        ...
        self.conv1 = nn.Conv2d(in_channels = 6, out_channels=10, kernel_size=(3, 3))
        self.relu1 = nn.ReLU()
        self.fc1 = nn.Linear(in_features=360, out_features=180)
        self.relu3 = nn.ReLU()
        self.fc2 = nn.Linear(in_features=180, out_features=classes)
